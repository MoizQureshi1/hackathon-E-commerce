            ...
            <div className="max-w-screen-2xl mx-auto">
                <div className="flex flex-col md:flex-row justify-center text-center md:text-left gap-8 my-16 mx-10">
                    <div className="border-2 bg-[#007580] p-12 px-16">
                        ...
                        <p className="text-slate-200 font-normal">At Comforty, We believe that the right chair can transform <br />your space and elevate your comfort. Specializing in <br />ergonomic design, premium materials, and modern <br />aesthetics, we craft chairs that seamlessly blend style <br />with functionality.</p>
                        <button className="py-4 px-10 mt-28 bg-[#F9F9F926] text-slate-200 transition-transform transform hover:scale-105">
                            View Collection
                        </button>
                    </div>
                    <div className="flex justify-center">
                        <Image src={whitechair2} alt="White Chair" width={480} height={320} className="" />
                    </div>
                </div>
                ...
                <div className="mx-10">
                    ...
                    <div className="text-[#007580] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-14 lg:mx-24">
                        ...
                        <div className="flex flex-col justify-center bg-slate-100 p-5">
                            ...
                            <p>Handmade Crafted goods <br />made with real passion and <br />craftsmanship</p>
                        </div>
                        <div className="flex flex-col justify-center bg-slate-100 p-5">
                            <LiaEnvelopeSolid className="text-2xl" />
                            <h2 className="text-xl my-2">Unbeatable prices</h2>
                            <p>For Our Materials and <br />quality you wont find better <br />prices anywhere</p>
                        </div>
                        <div className="flex flex-col justify-center bg-slate-100 p-5">
                ...
                <div className="lg:mx-10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 mb-32 lg:mx-28">
                        {CMSAbout.map((feature) => (
                            <div key={feature._id}>
                                <Link href={`/posts/${feature._id}`} className="flex justify-center transition-transform transform hover:scale-105">
