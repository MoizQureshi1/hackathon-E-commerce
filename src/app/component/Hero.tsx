        ...
        <main className="max-w-screen-2xl mx-auto">
            <div className="flex flex-col md:flex-row zjustify-around bg-slate-100 lg:mx-44 md:mx-20 md:pl-10 pt-16 py-11 lg:pl-20 rounded-md">
                ...
                <div className="text-indigo-950 mt-14 md:mt-10 text-center md:text-left">
                    ...
                    <Link href="blackchaircard" className="flex justify-center md:justify-start"> <button className="flex text-sm font-semibold py-3 px-7 rounded-lg bg-cyan-500 hover:bg-cyan-600 text-white transition-transform transform hover:scale-105">Shop Now <GoArrowRight className="text-xl mt-0.5 ml-4"/></button></Link>
                </div>
