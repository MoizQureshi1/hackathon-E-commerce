                ...
                <div className="flex justify-center gap-44 my-20">
                    ...
                    <div>
                        <form>
                            ...
                            <button className="border-2 rounded-xl mt-5 py-3 px-20 bg-cyan-700 transition-transform transform hover:scale-105">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
            <div className="flex justify-center gap-24 bg-gray-100 text-gray-900 mx-32 py-24">
                <div className="flex">
