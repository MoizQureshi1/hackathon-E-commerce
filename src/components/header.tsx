    ...
    return(
        <header className="border-b-2 max-w-screen-2xl mx-auto">
            ...
            <div className="flex justify-around text-[#636270] font-semibold lg:gap-36 sm:mt-6 bg-[#FFFFFF]">
                ...
                <p className="hidden sm:block">Contact: <span className="text-[#272343]">{CMSHeader.phone}</span></p>
            </div>
            <Sheet>
                ...
                <p className="block sm:hidden text-[#636270] font-semibold mt-1.5">Contact: <span className="text-[#272343]">{CMSHeader.phone}</span></p>
                </div>
